...
interface FilterAction {
    type: ActionTypes.FILTER_ELEMENT;
    payload: string;
}

export type Actions = AddItemAction | EditItemAction | DeleteItemAction | FilterAction;
...
export const filterItem = (text: string): FilterAction => ({
    type: ActionTypes.FILTER_ELEMENT,
    payload: text,
});